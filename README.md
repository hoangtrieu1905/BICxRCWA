...
- Known problematic slab row near `283.33 nm` can violate energy conservation (computed zeroth-order power exceeds 1.0), so that row should be excluded from analysis.
